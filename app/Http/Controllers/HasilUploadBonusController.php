...
class HasilUploadBonusController extends Controller
{
    public function index(Request $request)
    {
        ...
        $uploadBonuses = $query->orderBy('id', 'desc')->paginate(10)->appends($request->query());

        // dd($query->toSql(), $query->getBindings());
       // Kembalikan view dengan data
       return view('pages.hasil.bonus.index', compact('uploadBonuses'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.hasil.bonus.edit', compact('uploadBonuses'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $uploadBonuses = Bonus::find($id);
        $uploadBonuses->member = $request->member;
        $uploadBonuses->total = $request->total;
        $uploadBonuses->save();

        return redirect()->route('hasilbonus.index')->with('success', 'updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('hasilbonus.index')->with('success', 'deleted successfully.');
    }
