        ...
        <section class="section">
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="section-header-button">
                            <button type="submit"
                                class="btn btn-primary">Upload CashBack</button>
                        </div>
                     </form>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @if(Session::has('uploadedDataBonus') && Session::get('uploadedDataBonus')->isNotEmpty())
                        <h4>Hasil Upload:</h4>
                        <table class="table-striped table">
                            ...
                            @foreach (Session::get('uploadedDataBonus') as $data)
                            <tr>
                                <td>{{ $data->id }}</td>
                                <td>{{ $data->idupload }}</td>
